...
- **Settings Not Applying**: Restart the tracker, change the settings, then restart again. Settings sometimes need a couple of restarts before applying, especially if the game has been running for a while already.
